...
function getSentiment(text) {
    return __awaiter(this, void 0, void 0, function* () {
        const modelToUse = yield tf.loadLayersModel('https://storage.googleapis.com/tfjs-models/tfjs/sentiment_cnn_v1/model.json');
...
function getToxicity(text) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const model = yield tfToxicity.load(threshold, toxicityLabels);
